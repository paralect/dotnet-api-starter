...
namespace Common.DB.Mongo.DAL
{
    ...
    {
        public static void InitializeDb(IServiceCollection services, MongoDbSettings dbSettings)
        {
        ...
        private static void InitializeCollections(IServiceCollection services, MongoDbSettings dbSettings)
        {
